...
function isSafeInteger(num) {
  ...
  return Number.MAX_SAFE_INTEGER >= num && num >= Number.MIN_SAFE_INTEGER;
}
...
// Задача 6: Напишіть функцію, яка перевіряє, чи є число меншим ніж найменше можливе числове значення в JavaScript

function isAlmostZero(num) {
  // Перевіряємо, чи є число більше 0, але все ще менше за Number.MIN_VALUE
  return 0 > num && num > Number.MIN_VALUE;
}
